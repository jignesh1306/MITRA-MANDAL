...
export const approveLoanRequest = async (requestId, adminUserId, overrideInsufficientFund = false) => {
  ...
  await createNotification({
    ...
    type: 'LOAN_APPROVED',
    title: 'Loan Approved',
    message: `Your loan request of ₹${(request.amount / 100).toLocaleString('en-IN')} has been approved.`
  });
